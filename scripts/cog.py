...
def cog(seri):
    ...
    ## 将简称替换为全称
    list_store = [dic_annotation[rrep] if rrep in dic_annotation else rrep for rrep in list_store ]
    ...
    f = ax.barh(list_store.value_counts().index, 
                ...
                align='center', 
                 color=['C{}'.format(i) for i in range(1000)], # 添加了颜色信息，如果不添加则柱状图的每个柱子颜色均统一
